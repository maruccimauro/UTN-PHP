...
<body>
    ...
    <main>
        <?php ManagerResource::instantDependency("./templates/procesador_review.php", fn ($f) => include($f)); ?>
        <?php ManagerResource::instantDependency("./templates/review.php", fn ($f) => include($f)); ?>
