...
<body>
    ...
    <?php ManagerResource::instantDependency("./templates/deco_tittle.php", fn ($f) => require_once($f)); ?>
    <main>
        <?php ManagerResource::instantDependency("./templates/index.php", fn ($f) => include($f)); ?>
